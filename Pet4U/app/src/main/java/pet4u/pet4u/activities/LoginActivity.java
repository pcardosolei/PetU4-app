...
/*
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            UserLoginManager.getInstance().performLogin(email, password, LoginActivity.this);
        }
    }
    ...
    private boolean isEmailValid(String email) {
        //TODO: Replace this with your own logic email.contains("@")
        return true;
    }
